...
public class SimpleHttpClient {
   ...
   * <p>
   * 
   * @param szUrl : The URL we want to connect.
   */
   ...
   * 
   * @param method
   * @param type : "application/json", "application/x-www-form-urlencoded",
   *          "text/xml", ....
   * @throws Exception
   */
  public void connectProxyIGN(String method, String contentType) throws Exception {
    try {
      // Set IGN Proxy
